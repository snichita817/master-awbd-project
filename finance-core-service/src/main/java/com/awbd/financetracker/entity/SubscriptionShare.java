...
public class SubscriptionShare {
    ...
    public SubscriptionShare(Subscription subscription, Long participantUserId, BigDecimal percentageShare, BigDecimal fixedAmount) {
        this.id = new SubscriptionShareId(subscription.getId(), participantUserId);
